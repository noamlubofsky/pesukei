...
function Hallelukah3({size, language}) {
    ...
    `
    const english = `Praise God. Praise Adonoy from the sky; Praise Him in the heights! Praise Him, all His angels; Praise Him, all His hosts! Praise Him, sun and moon; Praise Him, all the stars of light. Praise Him, skies of skies, and the waters that are above the skies.23 They will praise the Name of Adonoy, for He commanded it and they were created. He established them for all time,24 for as long as the world exists; He decreed it and it is unalterable.25 Praise Adonoy from the earth, sea-monsters and all [that dwell in] the depths. Fire and hail, snow and vapor, stormwind, [all] fulfilling His word. The mountains and all the hills, fruit trees and all cedars. Wild beasts and all animals, creeping things and winged fowl. Earthly kings and all peoples, ministers and all earthly judges. Young men and also maidens, elders together with lads.26 They will praise the Name of Adonoy, for His Name alone is exalted; His majesty is over the earth and the skies. He will raise the might of His people, [which is] praise for all His pious ones, for the Children of Israel, the people near27 to Him. Praise God.
    `
