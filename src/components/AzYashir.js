...
function AzYashir({size, language}) {
    ...
    `
    const english = `
    On that day,3 Adonoy delivered Israel from the hand of Egypt, and Israel saw the Egyptians dead on the seashore. And Israel saw the great hand4 which Adonoy wielded against Egypt, and the people feared Adonoy, and they believed in Adonoy, and that Moses was His servant.
